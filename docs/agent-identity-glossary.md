...
| GoIDC | Self-described "Global Digital Identity Ecosystem" — a digital-identity and professional-networking platform (AI business cards, unified identity). It appears to be a product/platform rather than a technical OIDC standard. **Thinly grounded:** the site returned HTTP 403 to automated fetching; description is from public search snippets. Not a vocabulary source. | [goidc.in](https://goidc.in/index.html) — product platform, details thin |
